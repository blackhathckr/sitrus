 ...
 * Registration Page
 *
 * Creator registration page for the Sitrus platform.
 * Supports Google OAuth signup and email/password registration.
 *
        ...
        <div className="w-full max-w-md">
          <Card className="border-0 shadow-xl lg:border">
            <CardHeader className="space-y-2 text-center">
              ...
              <CardDescription>
                Create your account and start earning from product
                recommendations
              </CardDescription>
            </CardHeader>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Sitrus Club Private Limited
          </p>
        </div>
      </div>

      {/* Right Side - Lottie */}
      <div className="hidden flex-1 items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-8 lg:flex">
        <div className="w-full max-w-md">
          <PageLottie
            name="auth"
            description="Share products you love and earn from every click"
          />
        </div>
      </div>
    </div>
